export default [
    {
        ...
        aiPrompt: "Give me 5 blog topic ideas in bullet wise only based on a given niche topic & outline and give me result in Rich text editor format",
...

    {
        ...
        icon: '/templates/rewrite-article.png',
    ...
    },
    {
        ...
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: '/templates/instagram-post.png',
        category: 'blog',
    ...
    },
    {
        ...
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: '/templates/instagram-hash-tag.png',
        category: 'blog',
    ...
    },
    {
        ...
        icon: '/templates/instagram-reels.png',
        category: 'instagram',
    ...
    },
    {
        ...
        icon:'/templates/english-grammar.png',
        category: 'english',
    ...
    },
    {
        ...
        icon:'/templates/explain-code.png',
        category: 'Coding',
    ...
    },
    {
        ...
        icon:'/templates/tagline-generator.png',
        category: 'Marketting',
    ...
    },
    {
        ...
        icon:'/templates/product-description.png',
        category: 'Marketting',
